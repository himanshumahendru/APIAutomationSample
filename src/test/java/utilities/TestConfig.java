...
public class TestConfig{
	...
	public static String from = "himanshumahendru31@gmail.com";
	public static String password = "Himanshu@09876";
	public static String[] to ={"him.mahendru@gmail.com","himanshu.mahendru7@gmail.com"};
